      ...
      <div className="container">
        <div className="row container d-flex justify-content-center">
          <div className="col-lg-3 d-flex justify-content-center p-2">
            <img src="img/squall/001.png" alt="Image1" style={{ width: '300px', height: '300px' }} className="img-fluid" />
          </div>
          <div className="col-lg-3 col-md-4 col-sm-4 col-4 d-flex justify-content-center p-2">
            <img src="img/squall/002.png" alt="Image2" style={{ width: '300px', height: '300px' }} className="img-fluid" />
          </div>
          <div className="col-lg-3 col-md-4 col-sm-4 col-4 d-flex justify-content-center p-2">
            <img src="img/squall/003.png" alt="Image3" style={{ width: '300px', height: '300px' }} className="img-fluid" />
          </div>
